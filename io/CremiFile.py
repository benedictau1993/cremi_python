...
class CremiFile(object):
    ...
    def write_annotations(self, annotations):
        ...
        self.__create_dataset("/annotations/types", data=annotations.types(), dtype=h5py.special_dtype(vlen=str), compression="gzip")
        ...
        if len(annotations.comments) > 0:
            ...
            self.__create_dataset("/annotations/comments/comments", data=list(annotations.comments.values()), dtype=h5py.special_dtype(vlen=str))
